...
Although a version of this code is being used in production, **this gem should be considered a pre-release**. This gem has been used to replace our production instance, but has not yet been deployed.
